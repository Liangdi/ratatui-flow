...
fn ui(f: &mut Frame, _app: &App) {
	...
	let mut graph = NodeGraph::new(
		...
		vec![
			...
			Connection::new(1,0,2,0).with_line_type(LineType::Thick).with_line_style(Style::default().fg(Color::Red)), // b | c
			...
			Connection::new(5,0,4,1).with_line_type(LineType::Thick).with_line_style(Style::default().fg(Color::Red)), // f > e
